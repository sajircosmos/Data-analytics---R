wine <- read.csv("D:/excelR/Dataset/Wine.csv")
View(wine)
attach(wine)
wine5=scale(wine)
...
## Observation(s):
   ### When PCA was applied on the entire set of varibles (14); PCA suggested that 90% of the information can be inferred from the first 7 varaibles.
## then plotted dendrogram for both 14 varaibles and 7 varaibles data and found that the number of clustered required are 7 and the dendrogram seem identical.
